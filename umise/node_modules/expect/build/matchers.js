...
const matchers = {
  toBe(received, expected) {
    ...
    const message = pass ? () => (0, _jestMatcherUtils.matcherHint)('.toBe', undefined, undefined, {
      comment,
      isNot: true
      ...
      return (0, _jestMatcherUtils.matcherHint)('.toBe', undefined, undefined, {
        comment,
        isNot: false
      }) + '\n\n' + `Expected: ${(0, _jestMatcherUtils.printExpected)(expected)}\n` + `Received: ${(0, _jestMatcherUtils.printReceived)(received)}` + (diffString ? `\n\nDifference:\n\n${diffString}` : '') + (suggestToEqual ? ` ${_jestMatcherUtils.SUGGEST_TO_EQUAL}` : '');
    };
  ...
  toBeCloseTo(actual, expected) {
    ...
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeCloseTo', undefined, undefined, {
      isNot: this.isNot,
      secondArgument
  ...
  toBeDefined(actual, expected) {
    ...
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeDefined', 'received', '', {
      isNot: this.isNot
    }) + '\n\n' + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeFalsy(actual, expected) {
    ...
    const pass = !actual;
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeFalsy', 'received', '', {
      isNot: this.isNot
    }) + '\n\n' + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeGreaterThan(actual, expected) {
    ...
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeGreaterThan', undefined, undefined, {
      isNot: this.isNot
    }) + '\n\n' + `Expected: ${(0, _jestMatcherUtils.printExpected)(expected)}\n` + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeGreaterThanOrEqual(actual, expected) {
    ...
    const pass = actual >= expected;
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeGreaterThanOrEqual', undefined, undefined, {
      isNot: this.isNot
    }) + '\n\n' + `Expected: ${(0, _jestMatcherUtils.printExpected)(expected)}\n` + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeInstanceOf(received, constructor) {
    ...
    const message = pass ? () => (0, _jestMatcherUtils.matcherHint)('.toBeInstanceOf', 'value', 'constructor', {
      isNot: this.isNot
    }) + '\n\n' + `Expected constructor: ${(0, _jestMatcherUtils.EXPECTED_COLOR)(constructor.name || constructor)}\n` + `Received value: ${(0, _jestMatcherUtils.printReceived)(received)}` : () => (0, _jestMatcherUtils.matcherHint)('.toBeInstanceOf', 'value', 'constructor', {
      isNot: this.isNot
    }) + '\n\n' + `Expected constructor: ${(0, _jestMatcherUtils.EXPECTED_COLOR)(constructor.name || constructor)}\n` + `Received constructor: ${(0, _jestMatcherUtils.RECEIVED_COLOR)(received.constructor && received.constructor.name)}\n` + `Received value: ${(0, _jestMatcherUtils.printReceived)(received)}`;
  ...
  toBeLessThan(actual, expected) {
    ...
    const pass = actual < expected;
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeLessThan', undefined, undefined, {
      isNot: this.isNot
    }) + '\n\n' + `Expected: ${(0, _jestMatcherUtils.printExpected)(expected)}\n` + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeLessThanOrEqual(actual, expected) {
    ...
    const pass = actual <= expected;
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeLessThanOrEqual', undefined, undefined, {
      isNot: this.isNot
    }) + '\n\n' + `Expected: ${(0, _jestMatcherUtils.printExpected)(expected)}\n` + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeNaN(actual, expected) {
    ...
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeNaN', 'received', '', {
      isNot: this.isNot
    }) + '\n\n' + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeNull(actual, expected) {
    ...
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeNull', 'received', '', {
      isNot: this.isNot
    }) + '\n\n' + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeTruthy(actual, expected) {
    ...
    const pass = !!actual;
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeTruthy', 'received', '', {
      isNot: this.isNot
    }) + '\n\n' + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
    return { message, pass };
  },
  ...
  toBeUndefined(actual, expected) {
    ...
    const pass = actual === void 0;
    const message = () => (0, _jestMatcherUtils.matcherHint)('.toBeUndefined', 'received', '', {
      isNot: this.isNot
    }) + '\n\n' + `Received: ${(0, _jestMatcherUtils.printReceived)(actual)}`;
