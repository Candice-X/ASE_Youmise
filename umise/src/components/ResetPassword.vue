      ...
      <transition name="fade">
        <div id="signup_div" v-if='submittedValue'>
          ...
          <div class="form-label-group" :class="{ invalid: $v.user.confirmationCode.$error }">
            ...
            type="" @blur="$v.user.confirmationCode" v-model="user.confirmationCode">
            <label for="validateCode">Verification Code</label>
          </div>
  
          <div class="form-label-group" :class="{ invalid: $v.user.username.$error }">
            <input id="inputUserName" class="form-control" placeholder="UserName" @blur="$v.user.username.$touch()" 
            v-model="user.username">
            <label for="inputUserName">User Name</label>
          </div>
  
          <div class="form-label-group" :class="{ invalid: $v.user.password.$error }">
            <input id="inputPassword" class="form-control" placeholder="Password" @blur="$v.user.password.$touch()" 
